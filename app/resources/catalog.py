...
_DEFINITIONS = (
    ...
    ResourceDefinition(
        "omnivoice",
        "OmniVoice Local GPU",
        "Clone giọng và tạo TTS local bằng GPU NVIDIA",
        "~3.3 GB",
        "omnivoice",
        (
            "config.json",
        ...
        kind="model",
        capabilities=("omnivoice", "voice-cloning", "tts"),
        requires=("runtime:omnivoice",),
        repository_id="k2-fsa/OmniVoice",
        revision="c5fdb5ccb189668d56333f77ba2629f4cd7535f4",
        download_size=3_267_470_260,
        install_size=3_267_470_260,
    ),
)
...
_RUNTIME_DEFINITIONS = (
    ...
    ResourceDefinition(
        "runtime:omnivoice",
        "OmniVoice Runtime",
        "Thư viện OmniVoice 0.2.1; dùng chung PyTorch CUDA",
        "~850 MB",
        "runtime-omnivoice",
        ("site-packages/omnivoice/__init__.py", "runtime.json"),
        kind="runtime",
        device="cuda",
        protocol="ndjson-v1",
        capabilities=("omnivoice", "voice-cloning", "tts", "cuda"),
        feature="omnivoice",
        requires=("runtime:python:3.12", "runtime:torch:cuda"),
        download_size=850_000_000,
        install_size=1_900_000_000,
    ),
    ResourceDefinition(
        "runtime:opus-mt",
